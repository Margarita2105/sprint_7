...
class TestOrder:
    ...
    def test_order_new(self, login_generate, color):
        response = ApiMethodsOrder.order_new(login_generate[0], login_generate[1], Credential.address, Credential.metroStation, Credential.phone, Credential.deliveryDate, Credential.rentTime, Credential.comment, color)
